...
function loadMenu() {
    ...
    var menuHTML = `
        <nav style="display: flex; justify-content: center; gap: 30px; padding: 15px 20px; background: var(--menu-bg, rgba(10, 10, 21, 0.9)); border-bottom: 2px solid #c9a84c; margin-bottom: 20px; flex-wrap: wrap;">
            ...
            <a href="/OplotGuild/ships.html" style="color: var(--link-color, #e0d6b0); text-decoration: none; font-size: 1.1rem; padding: 5px 15px; border-radius: 5px; transition: 0.3s; ${currentPage === 'ships.html' ? 'border-bottom: 2px solid #c9a84c; color: #c9a84c;' : ''}">⚓ Верфь</a>
